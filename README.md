...
* *об ошибках:* судя по отчету из [тетрадки](https://github.com/pmashkovtseva/hse-4-nlp-final-project/blob/main/aspects/crf/apects_crf_train.ipynb), а именно хорошей accuracy и низкому f1 для всех категорий, кроме О (особенно I-) главная проблема - в недообучении. модели было дано достаточно О-примеров, и с ними она справляется хорошо, однако со всеми остальными есть значительные проблемы.
